...
SOURCE	 = 	main.c src/init/init.c src/parser/parser.c src/parser/parse_basic.c src/parser/parse_copy_map.c  \
			src/parser/parse_map.c src/free/free.c src/parser/parse_set_types.c src/parser/parse_utils.c \
...
$(NAME) : $(OBJECTS)
	@cd libs && make
	@$(CC) $(CFLAGS) $(MLXFLAGS) $(OBJECTS) libs/libs.a -o $(NAME) $(LEAKSANITIZER)
